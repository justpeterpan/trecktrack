...
export default {
  config: {
    classes: generateClasses({
      ...
      select: {
        inner:
          'max-w-md flex relative items-center rounded mb-1 ring-1 ring-gray-400 focus-within:ring-blue-500 focus-within:ring-2 [&>span:first-child]:focus-within:text-blue-500',
        input:
      ...
      textarea: {
        inner:
          'max-w-md flex rounded mb-1 ring-1 ring-gray-400 focus-within:ring-blue-500 [&>label:first-child]:focus-within:text-blue-500',
        input:
